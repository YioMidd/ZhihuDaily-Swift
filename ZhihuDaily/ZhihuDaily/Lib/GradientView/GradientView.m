...
- (void)resetWithType:(int)type {
    [[self.layer sublayers].firstObject removeFromSuperlayer];
    switch (type) {
        case TRANSPARENT_GRADIENT_TYPE:
            [self insertTransparentGradient];
            break;
        case COLOR_GRADIENT_TYPE:
            [self insertColorGradient];
            break;
        case TRANSPARENT_GRADIENT_TWICE_TYPE:
            [self insertTwiceTransparentGradient];
            break;
        case TRANSPARENT_ANOTHER_GRADIENT_TYPE:
            [self insertAnotherTransparentGradient];
            break;
        default:
            break;
...
- (void) insertTwiceTransparentGradient {
    ...
    UIColor *colorTwo = [UIColor colorWithRed:(0/255.0)  green:(0/255.0)  blue:(0/255.0)  alpha:0.1];
    UIColor *colorThree = [UIColor colorWithRed:(0/255.0)  green:(0/255.0)  blue:(0/255.0)  alpha:0.1];
    UIColor *colorFour = [UIColor colorWithRed:(0/255.0)  green:(0/255.0)  blue:(0/255.0)  alpha:0.35];
    NSArray *colors = [NSArray arrayWithObjects:(id)colorOne.CGColor, colorTwo.CGColor, colorThree.CGColor, colorFour.CGColor, nil];
    
    NSNumber *stopOne = [NSNumber numberWithFloat:0.0];
    NSNumber *stopTwo = [NSNumber numberWithFloat:0.35];
